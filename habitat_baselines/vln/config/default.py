...
_C.BERT_CONFIG = "/home/erick/Research/libs/habitat/habitat-api/habitat_baselines/vln/config/bert_base_6layer_6connect.json"
_C.BERT_GPU = 0
_C.BERT_PRE_TRAINED_MODEL = "bert-base-uncased"
_C.CAFFE_DEFAULT_IMG_SHAPE = (1,3,600,800)
_C.CAFFE_DEFAULT_INFO_SHAPE = (1,3)
_C.CAFFE_BASE_PATH = '/home/erick/Research/vln/libs/bottom-up-attention/'
_C.CAFFE_GPU = 1
_C.SIMULATOR_GPU = [2,3] 
